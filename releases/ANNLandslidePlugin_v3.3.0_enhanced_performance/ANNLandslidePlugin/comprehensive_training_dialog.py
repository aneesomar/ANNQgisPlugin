    ...
    def _train_from_rasters(self):
        ...
        try:
            ...
            result = trainer.train_model(
                ...
                num_epochs=self.kwargs.get('epochs', 50),      # Enhanced: Optimized epoch count
                batch_size=self.kwargs.get('batch_size', 128), # Enhanced: Larger batch size
                learning_rate=0.0005,                          # Enhanced: More stable learning rate
                patience=20,                                   # Enhanced: Extended patience
