...
class AnnLandslide:
    ...
    def __init__(self, iface):
        ...
        locale_path = os.path.join(
            self.plugin_dir,
            'i18n',
            'AnnLandslide_{}.qm'.format(locale))
        ...
        self.actions = []
        self.menu = self.tr(u'&ANN Landslide Susceptibility')
    ...
    def tr(self, message):
        ...
        return QCoreApplication.translate('AnnLandslide', message)
    ...
    def unload(self):
        ...
        for action in self.actions:
            self.iface.removePluginRasterMenu(
                self.tr(u'&ANN Landslide Susceptibility'),
                action)
